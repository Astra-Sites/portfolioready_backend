...
<head>
    ...
    <title>Portfolio Ready Online Course</title>
    <!-- Stylesheet -->
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css"/>
    <link rel="stylesheet" href="./styles/main.css" type="text/css">
    <link rel="icon" href="./assets/images/gree.png" type="images/png">
    <style>
...
<body>
    ...
    <main id="main">
        ...
        <section class="mb-12 lg:mb-16 xl:mb-24">
            <div class="container">
                <div class="bg-top-main pt-8 px-8 lg:pt-0 rounded-3xl lg:min-h-[500px] xl:min-h-[620px] 2xl:min-h-[760px] gap-y-14 flex flex-col lg:flex-row justify-between items-center bg-[#F1F6F1]">
                    <div class="lg:w-1/2 text-center items-center lg:items-start lg:text-start flex flex-col gap-y-6 lg:gap-y-8">
                        <h1 class="text-4xl leading-snug lg:text-5xl lg:leading-snug font-bold text-slate-800">
                            Learn to design & Build Softwares from scratch.
                        </h1>
                        <p class="text-slate-800/70 font-medium text-base lg:text-lg w-[90%]">Kickstart your web development journey with our top-rated courses, designed to equip you with practical skills and hands-on experience.</p>
                        <a class="h-12 w-44 text-white text-sm font-bold text-center leading-[3rem] rounded-xl transition-colors hover:bg-indigo-800" href="#contact" style="background-color: #71c55d;">Learn More</a>
                    </div>
                    <div class="lg:w-1/2 mt-auto">
                        <img class="" src="./assets/images/hero-bg.png" alt="">
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="flex flex-col gap-14 lg:gap-y-16 xl:gap-y-20">
                    ...
                    <div class="services-contents flex flex-col items-center justify-center lg:flex-row lg:justify-between lg:items-center gap-y-4 transition-all">
                        ...
                        <div class="text-center lg:text-start">
                            <!-- Title -->
                            <h3 class="text-sm  font-bold mb-3" id="Service" style="color: #71c55d;">ABOUT US</h3>
                            <!-- Subtitle -->
                            <p class="text-slate-800 text-3xl xs:text-4xl lg:max-w-[340px] leading-snug xs:leading-snug font-bold">Who We Are</p>
                        </div>
                        <!-- Right Side -->
                        <p class="text-center lg:text-start lg:max-w-screen-xs text-[15px] font-medium text-slate-800/70 -mb-8">Portfolio Ready is an online course for all programming levels—beginners, intermediates, and experts. With the AstraAI Tutor, learners solve real-world projects, innovate, and gain practical skills to thrive in the tech industry.</p>
                    </div>
                    <!-- Services -->
                    <div class="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-4 gap-5 child:transition-all child-hover:shadow-2xl mt-6 lg:mt-0 child-hover:shadow-slate-400/20 child-hover:border-gray-100 child:cursor-pointer">
                        ...
                        <div class="services-item rounded-[32px] border p-4 flex flex-col gap-y-4">
                            <img class="w-full rounded-[32px]" src="./assets/images/cards/1.png" alt="">
                            <div class="text-center space-y-2">
                                <h3 class="text-slate-800 font-bold">Scalable Learning</h3>
                                <p class="text-[15px] font-medium text-slate-800/50">The AI tutor ensures that each learner, regardless of their location or background, receives the same level of quality education and support. This scalability makes it possible for anyone, anywhere, to access high-quality learning resources and grow their skills.</p>
                            </div>
                        </div>
                        <!-- Service item -->
                        <div class="services-item rounded-[32px] border p-4 flex flex-col gap-y-4">
                            <img class="w-full rounded-[32px]" src="./assets/images/cards/2.png" alt="">
                            <div class="text-center space-y-2">
                                <h3 class="text-slate-800 font-bold">Data-Driven Insights</h3>
                                <p class="text-[15px] font-medium text-slate-800/50">AstraAI Tutor tracks your progress and learning patterns over time, providing valuable insights into your strengths and weaknesses. With this data, it helps you refine your study approach and offers suggestions for more effective learning strategies.</p>
                            </div>
                        </div>
                        <!-- Service item -->
                        <div class="services-item rounded-[32px] border p-4 flex flex-col gap-y-4">
                            <img class="w-full rounded-[32px]" src="./assets/images/cards/3.png" alt="">
                            <div class="text-center space-y-2">
                                <h3 class="text-slate-800 font-bold">Efficient Learning Path</h3>
                                <p class="text-[15px] font-medium text-slate-800/50">Through data-driven insights, the AstraAI Tutor identifies areas where you need more focus and adjusts your learning path accordingly. Whether you need to revisit a topic or dive deeper into advanced concepts, it ensures that your curriculum evolves to match your learning needs.</p>
                            </div>
                        </div>
                        <!-- Service item --> 
                        <div class="services-item rounded-[32px] border p-4 flex flex-col gap-y-4">
                            <img class="w-full rounded-[32px]" src="./assets/images/cards/4.png" alt="">
                            <div class="text-center space-y-2">
                                <h3 class="text-slate-800 font-bold">Personalized Learning</h3>
                                <p class="text-[15px] font-medium text-slate-800/50">The AstraAI Tutor customizes your learning experience based on your individual pace, strengths, and areas for improvement. It tailors lessons, assignments, and explanations to ensure that you understand key concepts before moving forward, optimizing your learning process.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="section my-20">
            <div class="container">
                <div class="flex flex-col lg:flex-row items-center gap-x-20 gap-y-12">
                    <!-- Emergency image -->
                    <div>
                        <img class="hidden lg:block" src="./assets/images/side1.png" style="width: 550px; height: auto;" alt="emergency-desktop">
                        <img class="lg:hidden" src="./assets/images/side1.png" style="width: 550px; height: auto;"  alt="emergency-mobile">
                    </div>
                    <!-- Emergency Contents -->
                    <div class="flex flex-col gap-y-4 text-center lg:text-start">
                        <!-- Title -->
                        <h4 class="text-sm  font-bold" style="color: #71c55d;">Dental 24H Emergency</h4>
                        <!-- Subtitle -->
                        <p class="text-slate-800 text-4xl leading-snug font-bold sm:max-w-screen-sm">Start Coding at the Right Level for You</p>
                        <!-- Description --> 
                        <p class="max-w-lg lg:max-w-md mx-auto lg:mx-0 text-[15px] font-medium text-slate-800/70">Whether you’re just starting out or already have knowledge in some programming concepts. Our AI-powered system evaluates your skills to determine the best starting point for you. Helping you build on what you know and master what you don’t. No matter your level, we’ll guide you every step of the way!</p>
                        <!-- Button Call to Action -->
                        <a class="h-12 w-44 mx-auto text-white text-sm font-bold text-center leading-[3rem] mt-6 lg:mt-8 lg:mx-0 rounded-xl transition-colors hover:bg-indigo-800" href="#contact" style="background-color: #71c55d;">Apply Today</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="section py-16">
            <div class="container">
                ...
                <!-- Feature Container -->
                <div class=" p-10 sm:p-12 md:px-16 md:py-[3.5rem] lg:px-32 lg:py-20 xl:py-24 xl:px-60 rounded-3xl" style="background-color: #e0fbe0;">
                    <!-- Feature info -->
                    <div class="flex flex-col gap-y-4 mb-12 sm:mb-14 md:mb-16 lg:mb-20 text-center lg:text-start">
                        <!-- Title -->
                        <h4 class="text-sm text-primary font-bold" style="color: #71c55d;">Features</h4>
                        <!-- Subtitle -->
                        <p class="text-slate-800 text-4xl leading-snug font-bold">Adaptive Learning Tailored Just for You!</p>
                        <!-- Description -->
                        <p class="text-[15px] font-medium text-slate-800/50">With Portfolio Ready, learning is tailored to your needs. Whether you’re a complete beginner or have prior experience, our AI-powered system ensures you start where you fit and grow effectively.</p>
                    </div>
                    <!-- Features -->
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-14">
                        ...
                        <div class="flex items-center flex-col xs:flex-row sm:flex-col lg:flex-row gap-4">
                            ...
                            <div class="text-center xs:text-start sm:text-center lg:text-start">
                                <!-- Feature item title -->
                                <p class="text-slate-800 font-bold mb-1">AI Skill Assessment</p>
                                <!-- Feature item Description -->
                                <p class="text-sm font-medium text-slate-800/50">Our advanced AI evaluates your current knowledge to find the perfect starting point for your learning journey.</p>
                            </div>
                        </div>
                        <!-- Feature item -->
                        <div class="flex items-center flex-col xs:flex-row sm:flex-col lg:flex-row gap-4">
                            ...
                            <div class="text-center xs:text-start sm:text-center lg:text-start">
                                <!-- Feature item title -->
                                <p class="text-slate-800 font-bold mb-1">Focus on What Matters</p>
                                <!-- Feature item Description -->
                                <p class="text-sm font-medium text-slate-800/50">Save time by skipping what you’ve mastered and diving straight into areas that need improvement.</p>
                            </div>
                        </div>
                        <!-- Feature item -->
                        <div class="flex items-center flex-col xs:flex-row sm:flex-col lg:flex-row gap-4">
                            ...
                            <div class="text-center xs:text-start sm:text-center lg:text-start">
                                <!-- Feature item title -->
                                <p class="text-slate-800 font-bold mb-1">Seamless Progression</p>
                                <!-- Feature item Description -->
                                <p class="text-sm font-medium text-slate-800/50">As you grow, the program adjusts to match your pace and challenges you appropriately.</p>
                            </div>
                        </div>
                        <!-- Feature item -->
                        <div class="flex items-center flex-col xs:flex-row sm:flex-col lg:flex-row gap-4">
                            ...
                            <div class="text-center xs:text-start sm:text-center lg:text-start">
                                <!-- Feature item title -->
                                <p class="text-slate-800 font-bold mb-1">Beginner-Friendly Approach</p>
                                <!-- Feature item Description -->
                                <p class="text-sm font-medium text-slate-800/50">No prior programming experience? No worries! We’ll guide you step-by-step from the basics.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="section py-16">
            <div class="container">
                <div class="flex flex-col lg:flex-row items-center gap-x-20 gap-y-12">
                    ...
                    <div class="flex flex-col gap-y-4 text-center lg:text-start">
                        <!-- Title -->
                        <h4 class="text-sm  font-bold" style="color: #71c55d;">EXPERTS IN DENTAL</h4>
                        <!-- Subtitle -->
                        <p class="text-slate-800 text-4xl leading-snug font-bold sm:max-w-screen-sm">First class dentistry, from top dentists.</p>
                        <!-- Description -->
                        <p class="max-w-lg lg:max-w-md mx-auto lg:mx-0 text-[15px] font-medium text-slate-800/70">Experience first-class dentistry from our top-rated dentists, ensuring exceptional oral health care for every patient.</p>
                        <div class="flex flex-col gap-y-2 child:text-[#181945] child:text-[15px] child:font-medium mt-4">
                            <p class="flex items-center gap-x-2">
                                <svg class="w-5 h-5" style="color: #71c55d;">
                     ...
                     <div class="flex order-first lg:order-last">
                        <img class="hidden lg:block" src="./assets/images/side2.png" style="width: 550px; height: auto; border-top-left-radius: 2rem;"  alt="expert-in-dental-desktop.png">
                        <img class="lg:hidden" src="./assets/images/side2.png" style="width: 550px; height: auto;border-top-left-radius: 2rem;"  alt="expert-in-dental-mobile.png">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="section py-16">
            <div class="container">
                <div class="rounded-3xl p-10 md:px-16 md:py-[3.5rem] lg:py-20 xl:py-24" style="background-color: #e0fbe0;">
                    ...
                    <div class="flex flex-col items-center justify-center lg:flex-row lg:justify-between lg:items-center gap-y-4">
                        ...
                        <div class="text-center lg:text-start">
                            <!-- Title -->
                            <h3 class="text-sm font-bold mb-3" style="color: #71c55d;">TESTIMONIAL</h3>
                            <!-- Subtitle -->
                        ...
                        <!-- Right Side -->
                        <p class="text-center lg:text-start lg:max-w-sm text-[15px] font-medium text-slate-800/70 -mb-8">Explore the glowing reviews and testimonials from our satisfied patients, highlighting our commitment to exceptional care and results.</p>
                    </div>
                    <!-- User TESTIMONIAL -->
                        ...
                        <div class="swiper-wrapper mt-28">
                            ...
                            <div class="swiper-slide relative bg-white rounded-3xl p-8">
                                ...
                                <div class="text-center mt-8">
                                    ...
                                    <!-- User Comment -->
                                    <p class="text-[15px] font-medium text-slate-800/70">"Edenbridge Dental Clinic provided friendly, thorough care. The dentist was knowledgeable and explained procedures well, leaving me reassured."</p>
                            ...
                            <div class="swiper-slide relative bg-white rounded-3xl p-8">
                                ...
                                <div class="text-center mt-8">
                                    ...
                                    <!-- User Comment -->
                                    <p class="text-[15px] font-medium text-slate-800/70">"Visiting Edenbridge Dental Clinic was a pleasant experience. The staff was welcoming, and the dentist was gentle yet efficient. I left feeling satisfied with the care I received."</p>
                                    <div class="flex items-center justify-center mt-6">
                                        <svg class="w-5 h-5 text-orange-star">
                                            <use href="#star"></use>
                                        </svg>
                            ...
                            <div class="swiper-slide relative bg-white rounded-3xl p-8">
                                ...
                                <div class="text-center mt-8">
                                    ...
                                    <!-- User Comment -->
                                    <p class="text-[15px] font-medium text-slate-800/70">"Great experience at Edenbridge Dental Clinic. Professional, caring staff exceeded expectations."</p>
                                    <div class="flex items-center justify-center mt-6">
                                        <svg class="w-5 h-5 text-orange-star">
                                            <use href="#star"></use>
                                        </svg>
                            ...
                            <div class="swiper-slide relative bg-white rounded-3xl p-8">
                                ...
                                <div class="text-center mt-8">
                                    ...
                                    <!-- User Comment -->
                                    <p class="text-[15px] font-medium text-slate-800/70">"Exceptional service at Edenbridge Dental Clinic. Highly recommended for thorough care."</p>
                                    <div class="flex items-center justify-center mt-6">
                                        <svg class="w-5 h-5 text-orange-star">
                                            <use href="#star"></use>
                                        </svg>
            ...
            <div class="container">
                <div class="flex flex-col lg:flex-row gap-y-6 gap-x-20">
                    ...
                    <div class="relative lg:w-1/2">
                        ...
                        <iframe class="block w-full h-[440px] xs:h-[500px] lg:h-[610px] xl:h-[680px] object-cover rounded-3xl" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d68154.41545721695!2d-98.21787225162815!3d26.1339808622031!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x866509b805d9390f%3A0x9c8f832d9e7dfc90!2sPharr%2C%20TX%2078577%2C%20USA!5e0!3m2!1sen!2ske!4v1721215942616!5m2!1sen!2ske" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        <!-- Absolute Address -->
                        <div class="absolute bg-white p-4 bottom-8 left-8 right-8 rounded-3xl flex gap-x-6 items-center">
                            ...
                            <div>
                                ...
                                <p class="font-bold text-slate-800 max-w-[260px]">100 West Moore Rd, Pharr TX.</p>
                            </div>
                        </div>
                    </div>
                    <div class="lg:w-1/2 bg-gray-100 px-4 pt-10 pb-4 rounded-3xl lg:bg-transparent lg:p-0 lg:rounded-none">
                        <!-- Contact us info -->
                        <div class="flex flex-col gap-y-4 text-center lg:text-start">
                            <h4 class="text-sm font-bold" style="color: #71c55d;">BOOK APPOINTMENT</h4>
                            <!-- Subtitle -->
                            <p class="text-slate-800 text-4xl leading-snug font-bold lg:max-w-screen-sm">Care at EdenBridge is pleasure</p>
                            <!-- Description -->
                            <p class="mx-auto lg:mx-0 text-[15px] font-medium text-slate-800/70">Booking at EdenBridge Dental Clinic ensures personalized, top-quality dental care with a focus on your comfort and well-being.</p>
                        </div>
                        <!-- Contact us form -->
                            ...
                            <div class="flex items-center justify-between sm:col-span-2">
                                ...
                                <div class="hidden sm:flex items-center gap-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-slate-800 font-bold mt-1">+1 424 250 3767</p>
                                    </div>
                                </div>
                                <!-- Submit button -->
                                 <div class="sub flex flex-col">
                                    <div id="liveAlertPlaceholder" class="alert alert-success bg-success" role="alert"></div>
                                    <button type="button" class="btn btn-primary h-12 w-full sm:w-44 text-white text-sm font-bold text-center leading-[3rem] rounded-xl transition-colors hover:bg-indigo-800" id="liveAlertBtn" style="background-color: #71c55d;">Book Appointment</button>
                                 </div>
                            </div>
                        </form>
                    </div>
    ...
    <!-- Footer -->
    <footer class=" mt-10" style="background-color: #71c55d;">
        <div class="container">  
                ...
                <div class="sm:col-span-2 lg:col-span-1">
                    <!-- Logo -->
                     <div class="logo flex items-center gap-4 ">
                        <img src="./assets/images/" alt="logo-footer">
                         <span style="font-weight: 600;">Portfolio Ready</span>
                     </div>
                    
                    <!-- Description -->
                    <p class="text-[15px] text-white/70  mt-4">For all your dental care needs, contact EdenBridge Dental Clinic. We're here to help you achieve a healthy smile.</p>
                    <!-- Social in footer -->
                    <div class="mt-8">
                    ...
                    <div class="flex flex-col gap-y-4 mt-6">
                        ...
                        <div class="flex items-center gap-x-4">
                            ...
                            <div>
                                ...
                                <p class="font-bold">+1 424 250 3767</p>
                            </div>
                        </div>
                        <!-- Contact info item -->
                        <div class="flex items-center gap-x-4">
...
<script>
            ...
            alertTrigger.addEventListener('click', () => {
                appendAlert('Thanks for contacting us! We will get back to you soon', 'success')
            })
            }
</script>
